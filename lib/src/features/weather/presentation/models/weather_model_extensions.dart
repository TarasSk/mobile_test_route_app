...
extension WeatherModelIconExtension on WeatherModel {
  Icon get weatherIcon {
    switch (description.toLowerCase()) {
      ...
      case 'rain':
        return const Icon(Icons.umbrella, color: Colors.blue, size: 20,);
      case 'snow':
      ...
      case 'haze':
        return const Icon(Icons.wb_cloudy, color: Colors.grey, size: 20,);
      case 'fog':   
        return const Icon(Icons.wb_sunny, color: Colors.grey, size: 20,);
